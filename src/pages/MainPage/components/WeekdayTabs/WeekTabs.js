      ...
      >
        {days.map((d) => (
          <button
            ...
            className={`flex-shrink-0 flex flex-col items-center justify-center px-8 py-3 rounded-xl font-semibold transition-all duration-300 shadow-lg transform hover:scale-105
              ${
                active === d.key
